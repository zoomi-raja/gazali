...
import vectorMap from '../components/vectorMaps'
                    ...
                    <div className="row gap-20 masonry pos-r">
                        ...
                        <div className="masonry-item w-100">
                            <div className="row gap-20">
                                ...
                                <div className="col-md-3">
                                    <div className="layers bd bgc-white p-20">
                                        <div className="layer w-100 mB-10"><h6 className="lh-1">Total Page Views</h6>
                                        </div>
                                        <div className="layer w-100">
                                            <div className="peers ai-sb fxw-nw">
                                ...
                                <div className="col-md-3">
                                    <div className="layers bd bgc-white p-20">
                                        <div className="layer w-100 mB-10"><h6 className="lh-1">Unique Visitor</h6>
                                        </div>
                                        <div className="layer w-100">
                                            <div className="peers ai-sb fxw-nw">
                                ...
                                <div className="peers fxw-nw@lg+ ai-s">
                                    <div className="peer peer-greed w-70p@lg+ w-100@lg- p-20">
                                        <div className="layers">
                                            <div className="layer w-100 mB-10"><h6 className="lh-1">Site Visits</h6>
                                            </div>
                                            <div className="layer w-100">
                                    ...
                                    <div className="peer bdL p-20 w-30p@lg+ w-100p@lg-">
                                        <div className="layers">
                                            <div className="layer w-100">
                                                <div className="layers">
                                                    <div className="layer w-100"><h5 className="mB-5">100k</h5>
                                                        ...
                                                        <div className="progress mT-10">
                                                            <div className="progress-bar bgc-deep-purple-500"
                                                                 ...
                                                                 aria-valuemax="100"
                                                                 style={prce50}><span className="sr-only">50% Complete</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="layer w-100 mT-15"><h5 className="mB-5">1M</h5>
                                                        <small className="fw-600 c-grey-700">Visitors From Europe
                                                        </small>
                                                        <span className="pull-right c-grey-600 fsz-sm">80%</span>
                                                        <div className="progress mT-10">
                                                            <div className="progress-bar bgc-green-500"
                                                                 role="progressbar"
                                                                 aria-valuenow="50" aria-valuemin="0"
                                                                 aria-valuemax="100"
                                                                 style={prce80}><span className="sr-only">80% Complete</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="layer w-100 mT-15"><h5 className="mB-5">450k</h5>
                                                        <small className="fw-600 c-grey-700">Visitors From Australia
                                                        </small>
                                                        ...
                                                        <div className="progress mT-10">
                                                            <div className="progress-bar bgc-light-blue-500"
                                                                 ...
                                                                 aria-valuenow="50" aria-valuemin="0"
                                                                 aria-valuemax="100"
                                                                 style={prce40}><span className="sr-only">40% Complete</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="layer w-100 mT-15"><h5 className="mB-5">1B</h5>
                                                        ...
                                                        <div className="progress mT-10">
                                                            <div className="progress-bar bgc-blue-grey-500"
                                                                 ...
                                                                 aria-valuenow="50" aria-valuemin="0"
                                                                 aria-valuemax="100"
                                                                 style={prce90}><span className="sr-only">90% Complete</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div className="masonry-item col-md-6">
                            <div className="bd bgc-white">
                                <div className="layers">
                                    <div className="layer w-100 pX-20 pT-20"><h6 className="lh-1">Monthly Stats</h6>
                                    </div>
                                    ...
                                    <div className="layer bdT p-20 w-100">
                                        <div className="peers ai-c jc-c gapX-20">
                                            <div className="peer"><span
                                                className="fsz-def fw-600 mR-10 c-grey-800">10% <i
                                                className="fa fa-level-up c-green-500"></i></span>
                                                <small className="c-grey-500 fw-600">APPL</small>
                                            </div>
                                            <div className="peer fw-600"><span
                                                className="fsz-def fw-600 mR-10 c-grey-800">2% <i
                                                className="fa fa-level-down c-red-500"></i></span>
                                            ...
                                            <li className="list-group-item bdw-0" data-role="task">
                                                <div className="checkbox checkbox-circle checkbox-info peers ai-c">
                                                    <input
                                                        ...
                                                        className="peer"/> <label htmlFor="inputCall5"
                                                                                  className="peers peer-greed js-sb ai-c"><span
                                                    className="peer peer-greed">Watch Game of Thrones Episode</span>
                                        ...
                                        <div className="peers ai-c jc-sb fxw-nw">
                                                ...
                                                <div className="layers">
                                                    <div className="layer w-100">
                                                        <div className="peers fxw-nw ai-c">
                                                            ...
                                                            <div className="peer">
                                                                <canvas className="sleet" width="44"
                                                                        height="44"></canvas>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="peer">
                                                <div className="layers ai-fe">
                                                    ...
                                                    <div className="layer"><span className="fw-600 c-grey-600">Nov, 01 2017</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="layers bdB">
                                            ...
                                            <div className="layer w-100 bdT pY-5">
                                                <div className="peers ai-c jc-sb fxw-nw">
                                                    ...
                                                    <div className="peer ta-r"><span className="fw-600 c-grey-800">05:00 AM</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="layer w-100 bdT pY-5">
                                                <div className="peers ai-c jc-sb fxw-nw">
                                                    ...
                                                    <div className="peer ta-r"><span
                                                        className="fw-600 c-grey-800">1B</span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="layer w-100">
                                        <div className="bgc-grey-200 p-20 gapY-15">
                                            <div className="peers fxw-nw">
                                                <div className="peer mR-20"><img className="w-2r bdrs-50p"
                                                    ...
                                                    <div className="layers ai-fe gapY-10">
                                                        <div className="layer">
                                                            <div
                                                                ...
                                                                <div className="peer-greed ord-0"><span>Heloo</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="layer">
                                        ...
                                        <div className="p-20 bdT bgc-white">
                                            <div className="pos-r"><input type="text"

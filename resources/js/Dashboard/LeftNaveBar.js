                ...
                <div className="sidebar-inner">
                    <div className="sidebar-logo">
                        <div className="peers ai-c fxw-nw">
                            ...
                            <div className="peer">
                                <div className="mobile-toggle sidebar-toggle"><a href="" className="td-n"><i
                    ...
                    <ul className="sidebar-menu scrollable pos-r">
                        <li className="nav-item mT-30">
                            <NavLink className="sidebar-link" to={"/gazali/admin/user"} activeClassName="active">
                        ...
                        <li className="nav-item">
                            ...
                            <span className="icon-holder">
                                <i className="c-blue-500 ti-share"></i> </span>
                        ...
                        <li className="nav-item">
                            ...
                            </span><span className="title">Charts</span>
                            </a>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item dropdown"><a className="dropdown-toggle" href="javascript:void(0);"><span
                        ...
                        <li className="nav-item dropdown"><a className="dropdown-toggle" href="javascript:void(0);"><span
                            ...
                            className="title">Multiple Levels</span> <span className="arrow"><i
                            className="ti-angle-right"></i></span></a>
                            <ul className="dropdown-menu">
                                <li className="nav-item dropdown"><a href="javascript:void(0);"><span>Menu Item</span></a>
                                </li>
                                <li className="nav-item dropdown"><a href="javascript:void(0);"><span>Menu Item</span> <span
